export default function Page() {
  return (
    <main>
      <section className="px-4 sm:px-6 mb-8" data-tag="">
        <div className="max-w-xl mx-auto py-16 md:py-20 flex flex-col gap-3 items-center justify-center text-center">
          <figure className="rounded-full h-full relative">
            <picture>
              <source
                srcSet="/content/images/size/w100/format/webp/2024/04/mana.png 100w, /content/images/size/w320/format/webp/2024/04/mana.png 320w, /content/images/size/w640/format/webp/2024/04/mana.png 600w"
                sizes="(max-width: 600px) 100px, 160px"
                type="image/webp"
              />
              <img
                className="w-full object-cover w-20 h-20 rounded-full aspect-square"
                loading="eager"
                srcSet="/content/images/size/w100/format/webp/2024/04/mana.png 100w, /content/images/size/w320/format/webp/2024/04/mana.png 320w, /content/images/size/w640/format/webp/2024/04/mana.png 600w"
                sizes="(max-width: 600px) 100px, 160px"
                src="/content/images/size/w30/2024/04/mana.png"
                alt="Features"
              />
            </picture>
          </figure>
          <h1 className="font-semibold tracking-tight text-2xl md:text-3xl lg:text-4xl xl:text-5xl">
            Features
          </h1>
        </div>
      </section>
